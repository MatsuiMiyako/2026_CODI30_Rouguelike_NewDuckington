...
item_effect() {
    if [[ "$PART_1" == "true" ]]; then
        ...
        They antagonized them for all ducks today, under the guise of: 'one cannot speak of Old Duckington.' When the asteroid hit, the fighting ducks obtained superpowers. "

    else
        echo "You don't actually know or remember anything. Your mind has been blank as a canvas. Since the asteriod hit and you were recruited to New Duckington, all you remember is your training."
    fi
}
